...
## 8. Simplificação antes da próxima evolução — publicada em 24/09/2026
...
A revisão foi publicada na `main` pelo commit `39ddc28` e o deploy correspondente ficou pronto na Netlify.
